                ...
                <div className="flex justify-between h-full">
                    ...
                    <form className="text-gray-700 text-center flex items-center align-items h-full w-52 hidden md:flex">
                        <input 
                            ...
                            name="email" 
                            id="email"
                            className="w-full text-gray-400 text-sm border border-gray-primary p-2 rounded h-7 bg-gray-200"
                            placeholder=' 🔍 Search '
                        />
                    </form>
                                    ...
                                    >
                                        ...
                                        <div className={`${isAvatarClicked ? '' : 'hidden'} absolute top-12 right-0 w-48 bg-white shadow-md rounded`}>
                                            <ul>
                                                ...
                                                >
                                                    <Link to={`/p/${user.displayName}`} className='cursor-pointer flex justify-start items-center w-full px-4 py-2 text-sm font-400'>
                                                        <svg 
